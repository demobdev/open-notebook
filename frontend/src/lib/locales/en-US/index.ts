export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Audioprism API server could not be reached",
    ...
    docLink: "Audioprism Documentation",
  ...
  sources: {
    ...
    sourceReadyDesc: "\"{title}\" has been processed and is ready to use.",
    sourceFailed: "Source Processing Failed",
    sourceFailedDesc: "\"{title}\" could not be processed. You can retry from the source card.",
  ...
  podcasts: {
    ...
    useEpisodeDefault: "Use episode default",
    sources: "Sources",
    notes: "Notes",
    ...
    podcastReadyDesc: "Your episode is ready to listen.",
    podcastFailed: "Podcast Generation Failed",
    podcastFailedDesc: "Episode generation encountered an error. You can retry from the episodes list.",
    buildingContext: "Building context from selected sources...",
    ...
    outlineLoadingDesc: "Outline will appear when generation completes.",
    transcriptLoadingDesc: "Transcript will appear when generation completes.",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Audioprism to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Audioprism is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
    ...
    jobs: {
      ...
      desc: "View podcast generation, ingest, and other async jobs",
      refresh: "Refresh",
      empty: "No jobs found. Jobs appear when you generate podcasts or process sources.",
      jobId: "Job ID",
      app: "App",
      command: "Command",
      status: "Status",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Audioprism",
    missingRequiredModels: "Missing required models: {models}. Audioprism may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Audioprism.",
